...
const About = () => {
  return (
    <section className='section pb-12 flex flex-col gap-[40px]'>
      ...
      <div className='gradient-02 absolute z-0 bottom-0 right-0 w-[140px] h-[80px] sm:h-[100px]' />
      ...
      <div className='gradient-01 absolute z-0 bottom-0 left-0 w-[140px] h-[80px] sm:h-[100px]' />
    </section>
  )
}
